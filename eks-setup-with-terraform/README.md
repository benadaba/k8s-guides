...
### **<span style="color:green">Contacts: c<br> WebSite : <http://datapandas.com/></span>**
...
```
``` sh
$ git clone https://github.com/benadaba/eks-terraform-setup
...
$ source ~/.bashrc  
# run the scripts https://github.com/benadaba/eks-terraform-setup/blob/main/terraform-install.sh
...
``` sh
$ git clone https://github.com/be/eks-terraform-setup
$ cd eks-terraform-setup
```
