...
kubectl run my-first-pod --image benadabankah/ourhttpdwebsite:v1 --generator=run-pod/v1
```
...
```
kubectl run my-first-pod --image benadabankah/ourhttpdwebsite:v1
```  
