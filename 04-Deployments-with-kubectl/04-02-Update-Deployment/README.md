# DataPandas== Kubernetes Update Deployments
...
kubectl set image deployment/my-first-deployment hello=benadabankah/ourhttpdwebsite:v1 --record=true
```
...
# Change From 2.0.0
    spec:
      containers:
      - image: benadabankah/ourhttpdwebsite:v2

# Change To 3.0.0
    spec:
      containers:
      - image: benadabankah/ourhttpdwebsite:v3
```
