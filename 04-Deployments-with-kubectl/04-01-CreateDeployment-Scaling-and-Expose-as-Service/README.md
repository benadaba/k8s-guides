# DataPandas == Kubernetes - Deployment
...
- **Docker Image Location:** https://hub.docker.com/r/benadabankah/nginx
```
# Create Deployment
kubectl create deployment <Deplyment-Name> --image=<Container-Image>
kubectl create deployment my-first-deployment --image=benadabankah/ourhttpdwebsite:v1
